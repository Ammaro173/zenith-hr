...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      className={cn(
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-primary/50 backdrop-blur-lg data-[state=closed]:animate-out data-[state=open]:animate-in",
        className
      )}
