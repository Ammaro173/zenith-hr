...
const buttonVariants = cva(
  "group inline-flex inline-flex shrink-0 cursor-pointer cursor-pointer items-center items-center justify-center justify-center gap-2 whitespace-nowrap whitespace-nowrap whitespace-nowrap rounded-md font-medium font-medium text-sm text-sm outline-none ring-offset-background transition-[color,box-shadow] transition-all focus-visible:border-ring focus-visible:outline-hidden focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 disabled:opacity-60 has-data-[arrow=true]:justify-between aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        lg: "h-10 gap-1.5 rounded-md px-4 text-sm has-[>svg]:px-4 [&_svg:not([class*=size-])]:size-4",
        md: "h-9 gap-1.5 px-3 text-sm [&_svg:not([class*=size-])]:size-4",
        sm: "h-8 gap-1.25 gap-1.5 rounded-md px-2.5 text-xs has-[>svg]:px-2.5 [&_svg:not([class*=size-])]:size-3.5",
