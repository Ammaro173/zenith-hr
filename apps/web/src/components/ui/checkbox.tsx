...
const checkboxVariants = cva(
  `
    ...
    peer size-4 shadow-xs outline-none transition-shadow focus-visible:border-ring dark:bg-input/30 dark:data-[state=checked]:bg-primary dark:aria-invalid:ring-destructive/40
    `,
  {
    variants: {
      size: {
